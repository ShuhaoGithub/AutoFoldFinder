...
from prokit.models.trrosetta_models_zsh import TrRosettaModelKL, TrRosettaModelPred
...
from prokit.optimizers.MCMC_optimizer_xyj import MCMCOptimizer
...
#     config.npz_list = ['../data/experiments/exp4/output/final_seq_160.npz','../data/experiments/exp4/output/final_seq_717.npz','../data/experiments/exp4/output/final_seq_781.npz','../data/experiments/exp3/output/final_seq_959.npz','../data/experiments/exp4/output/final_seq_621.npz','../data/experiments/exp33/output/final_seq_3.npz']
#     config.weight_list = [1,1,0.5,1,0.5,1]
    config.npz_list = ['6H5H_novel_JCIM.npz']
    config.weight_list = [1]
